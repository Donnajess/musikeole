...
<div class="container">
	...
	<div class="row">
		<div class="col-md-10">
			<form action="cGestionEquipePedagogique.php?action=validerModification" method="POST" enctype="multipart/form-data" role="form" class="form-horizontal">
		...
		<div class="col-md-2">
			<hr>
			<img <?php echo 'src="../data/images/equipePedagogique/'.$membre->getPhoto().'?v='.time().'"'; ?> class="img-responsive img-thumbnail">
