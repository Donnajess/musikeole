...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<h1>Ajouter un membre de l'équipe pédagogique</h1>
		</div>
	</div>

	<div class="row">
		<div class="col-md-12">
			<form action="cGestionEquipePedagogique.php?action=valider" method="POST" enctype="multipart/form-data" role="form" class="form-horizontal">
